...
export const normalizeQueueAlert = (queueInfo) => {
	...
	&& (
		estimatedWaitTime
			? I18n.t('Your spot is <strong>#%{spot}</strong> (Estimated wait time: <strong>%{estimatedWaitTime}</strong>)', { spot, estimatedWaitTime })
			: I18n.t('Your spot is <strong>#%{spot}</strong>', { spot })
	);
};
